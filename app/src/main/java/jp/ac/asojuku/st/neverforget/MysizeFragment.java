...
public class MysizeFragment extends Fragment {
    ...
    public void onPause() {
        super.onPause();
        EditText edText1 = (EditText) getView().findViewById(R.id.editText1);
        EditText edText2 = (EditText) getView().findViewById(R.id.editText1);
        EditText edText3 = (EditText) getView().findViewById(R.id.editText1);
        EditText edText4 = (EditText) getView().findViewById(R.id.editText1);
        int neck;
        try {
